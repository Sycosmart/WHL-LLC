...
`js/main.js`) currently just opens the visitor's email client, with no
...
4 pages, but becomes tedious to maintain past roughly 6 to 8 pages. When
that happens, the recommended move is a **static site generator** like
[11ty (Eleventy)](https://www.11ty.dev/):

- It still outputs plain static HTML/CSS/JS in the end, so hosting
